...
function App() {
  ...
  //Check if it can connect to the Contract
  const canConnectContract = account && web3Api.contract

  // If account or network chain changes, reload page
  const setAccountListerner = (provider) => {

    // to simplify just do a full window reload
      ...
      <div className="faucet-wrapper">
        <div className="faucet">
          ...
          <div className="balance-view is-size-2 my-4">
            Current Balance: {balance ? balance : "N/A"} ETH
          </div>
          {!canConnectContract &&
